...
class Menu extends Component {
    ...
    handleSubmit(event) {
        ...
        var instance = axios.create({
            baseURL: 'http://localhost:4000/user-account/create-user-account/',
            headers: {
        ...
        instance.post("?username=" + this.state.username + "&password=" + this.state.password
        + "&name=" + this.state.name + "&email=" + this.state.email + "&phone=" + this.state.phone).then(result => {
            console.log(result);
            return result.data;
